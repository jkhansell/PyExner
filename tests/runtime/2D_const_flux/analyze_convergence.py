...
def calculate_norms(dh_values, target_time=10.0):
    ...
    return valid_dh, (L1_h, L2_h, Linf_h), (L1_zb, L2_zb, Linf_zb)

def plot_convergence(dh_values, norms_h, norms_zb, outdir="results_convergence"):
...
if __name__ == "__main__":
    ...
    valid_dh, norms_h, norms_zb = calculate_norms(dh_values_to_check, target_time)
    
    if len(valid_dh) > 0:
        plot_convergence(valid_dh, norms_h, norms_zb)
